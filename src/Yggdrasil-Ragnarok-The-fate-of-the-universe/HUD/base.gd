...
var operating=false
var speaking=false
var dialogos=["Cumple tu destino y enfrenta a Fenrir.",
"Avanza hacia el pozo de Urd y ten cuidado con los gusanos.",
"Salvanos del Ragnarok.Que la voluntad divina te acompañe."] # fin de la pelicula 
